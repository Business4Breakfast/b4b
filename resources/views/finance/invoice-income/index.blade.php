            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <div class="row">
                            <form id="user_form" class="" method="GET" action="{{ route('finance.invoice-income.index') }}" >
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <a href="{{route('finance.invoice-income.index', ['reset' => true])}}" class="btn btn-danger"><i class="fa fa-close"></i> </a>
                    ...
                    <div class="ibox-content">
                        <div class="table-responsive">
                            ...
                            <thead>
                            <tr>
                                <th width="5%">Interné</th>
                                <th width="5%">Var.symbol</th>
                                <th>Firma</th>
                                <th class="text-right">Cena</th>
                                <th class="text-right">Uhradene</th>
                                <th>Splatnosť</th>
                                <th>Stav</th>
                                <th width="200px"></th>
                            </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">{{number_format((float) $sum['price_paid'], 2, ',', ' ')}}</td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                            ...
                            @if($items)
                                ...
                                <tr>
                                    <td><b>{{ $v->internal_id }}</b></td>
                                    <td>{{ $v->variable_symbol }}</td>
                                    <td>{{ $v->suplier_company }}</td>
                                    <td align="right"><strong>{{ number_format((float)$v->price_w_dph, 2, ',', ' ')}}</strong></td>
                                    <td align="right"><strong>{{ number_format((float)$v->price_paid, 2, ',', ' ') }}</strong></td>
                                    ...
                                    <td>
                                        ...
                                        {{ Form::open(['method' => 'DELETE', 'route' => ['finance.invoice-income.destroy', $v->id ],
                                        ...
                                        <a href="{{ route('finance.invoice-income.show', ['user' => $v->id ]) }}" type="button" class="pull-right btn btn-info btn-xs m-l-sm"> <i class="fa fa-money"></i> </a>
                                        <a href="{{ route('finance.invoice-income.edit', ['user' => $v->id ]) }}" type="button" class="pull-right btn btn-success btn-xs m-l-sm"><i class="fa fa-edit"></i> </a>
                                    </td>
                                </tr>
                                @endforeach
                            @endif
