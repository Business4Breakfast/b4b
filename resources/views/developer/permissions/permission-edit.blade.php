            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        {!! Form::open(['route' => 'developer.permission.save', 'method' => 'POST' ,'class' => 'form-horizontal']) !!}
                        ...
                        {!! Form::hidden('permission_id', $permission->id)!!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="display-name" name="display_name" value="{{ $permission->display_name }}">
                                </div>
                            </div>
                            <div class="form-group">
