            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        {!! Form::open(['route' => ['setting.membership.renewal.store'], 'method' => 'POST' ,'class' => 'form-horizontal', 'id' => 'membership_form']) !!}
                            {!! Form::hidden('renew_id', $membership->id) !!}

                            <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                <label for="price" class="col-md-4 control-label">Pôvodné členstvo</label>
                                <div class="col-md-4">
                                    <p> (číslo: #{{ $membership->id }} )  {{$data['valid_from']}} - {{$data['valid_to']}}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('valid_from') ? ' has-error' : '' }} date_picker_year" >
                                ...
                                <div class="col-md-2">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control date_mask" value="{{ $data['renew_from'] }}" name="valid_from" >
                                    </div>
                            ...
                            <div class="form-group{{ $errors->has('valid_to') ? ' has-error' : '' }} date_picker_year" >
                                ...
                                <div class="col-md-2">
                                    <div class="input-group date">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                        <input type="text" class="form-control date_mask" value="{{ $data['renew_to'] }}" name="valid_to" >
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}" id="div_pay_to_day">
                                        <label for="price" class="col-md-4 control-label">Splatnosť</label>
                                        <div class="form-group{{ $errors->has('valid_to') ? ' has-error' : '' }} date_picker_year" >
                                            <div class="col-md-4">
                                                <div class="input-group date">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                    <input type="text" class="form-control date_mask" value="{{ $data['renew_pay_to'] }}" name="renew_pay_to" >
                                                </div>
                                                @if ($errors->has('valid_to'))
                                                    <span class="help-block">
                                                        <strong>{{ $errors->first('valid_to') }}</strong>
