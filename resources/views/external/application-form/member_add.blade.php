                ...
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <form id="new_member_form" enctype="multipart/form-data" class="form-horizontal" method="POST" action="{{ route('ext.application.form.member.store') }}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group{{ $errors->has('invite_person') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="invite_person" type="text" class="form-control" name="invite_person" value="" readonly>
                                ...
                                <div class="form-group{{ $errors->has('club') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" name="club" class="form-control" required>
                                            <option value="">-- výber --</option>
                                            @foreach($clubs as $c)
                                                <option value="{{$c->id}}" @if(old('club') == $c->id ) selected="selected" @endif>{{$c->short_title}} ({{$c->address_city}})</option>
                                            @endforeach
                                        </select>
                                        @if ($errors->has('club'))
                                            <span class="help-block">
                                ...
                                <div class="form-group {{ $errors->has('gender') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-5 inline">
                                        <div class="col-md-4">
                                            ...
                                            <input type="radio" name="gender" id="M" value="M" class="form-control"  @if(isset($user->gender) && $user->gender == "M" ) checked="checked" @endif>
                                            <label for="gender" class="text-normal">
                                                Muž
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                                            <input type="radio" name="gender" id="F" value="F" class="form-control"  @if(isset($user->gender) && $user->gender == "F" ) checked="checked" @endif>
                                            <label for="gender" class="text-normal">
                                                Žena
                                            </label>
                                        </div>
                                ...
                                <div class="form-group{{ $errors->has('title_before') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-2">
                                        <input id="title_before" type="text" maxlength="10" class="form-control" name="title_before" value="{{ (isset($user->title_before)) ? $user->title_before : null }}" autofocus>
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text" class="form-control" name="name" value="{{ (isset($user->name)) ? $user->name : null }}" required>
                                ...
                                <div class="form-group{{ $errors->has('surname') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="surname" type="text" class="form-control" name="surname" value="{{ (isset($user->surname)) ? $user->surname : null }}" required>
                                ...
                                <div class="form-group{{ $errors->has('title_after') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-2">
                                        <input id="title_after" type="text" maxlength="10" class="form-control" name="title_after" value="{{ (isset($user->title_after)) ? $user->title_after  : null}}">
                                ...
                                <div class="form-group{{ $errors->has('date_birth') ? ' has-error' : '' }} date_picker_year" >
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group date">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            <input type="text" class="form-control date_mask" value="{{ Carbon\Carbon::now()->format('d.m.Y') }}" name="date_birth" >
                                        </div>
                                        @if ($errors->has('date_create'))
                                            <span class="help-block">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-4">
                                        <div class="checkbox">
                                            ...
                                            <input id="accept_condition" type="checkbox" class="form-control" name="accept_condition" value="1" >
                                            <label for="checkbox">
