...
<tr>
    <td class="wrapper">
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <h2>{{ __('email.invoice_new_member_title') }}</h2>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <br>
                    {{ Lang::get('email.invoice_new_member_text1') }}<br>
                    <br>
                    {{ Lang::get('email.invoice_new_member_text2') }}<br>
                    <br>
                    {{ Lang::get('email.invoice_new_member_text3') }}<br>
                    <br>
                    {{ Lang::get('email.invoice_new_member_text4') }}<br>
                    <br>
