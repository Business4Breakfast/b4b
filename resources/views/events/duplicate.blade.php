                    ...
                    <div class="ibox-content">
                        ...
                        <form id="event_form" class="form-horizontal" method="POST" action="{{ route('events.listing.store') }}" enctype="multipart/form-data" >
                            ...
                            <div class="form-group{{ $errors->has('date_create') ? ' has-error' : '' }} date_picker_year" >
                                ...
                                <div class="col-md-3">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control date_mask" value="" name="date_create" >
                                    </div>
                            ...
                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea id="description" class="form-control" name="description" rows="6">{{ $event->description  }}</textarea>
