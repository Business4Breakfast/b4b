...
class EventActivityListController extends Controller
{

    protected $module = 'event-activity'; // name of module
    protected $table = 'events_activities_list'; // name of module
